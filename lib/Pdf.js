...
var Pdf = function (_React$Component) {
  ...
  function Pdf(props) {
    ...
    _this.onPageRender = _this.onPageRender.bind(_this);

    if (!(typeof _this.onPageRender === 'function')) {
      throw new TypeError('Value of "this.onPageRender" violates contract.\n\nExpected:\n(any) => any\n\nGot:\n' + _inspect(_this.onPageRender));
    }
  ...
  (0, _createClass3.default)(Pdf, [{
    ...
    key: 'onPageRender',
    value: function onPageRender(page) {
      var onPageRender = this.props.onPageRender;
    ...
    value: function renderPdf() {
      ...
      if (page) {
        ...
        page.render({ canvasContext: canvasContext, viewport: viewport }).then(function () {
          return _this3.onPageRender(page);
        });
      }
    }
  }, {
...
Pdf.propTypes = {
  ...
  file: _react2.default.PropTypes.any,
  ...
  onPageRender: _react2.default.PropTypes.func,
